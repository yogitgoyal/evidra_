...
export function AlertsFeed({ items = [] }: { items?: AlertItem[] }) {
  ...
  return (
    <Card initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="p-6">
      <div className="mb-4 flex items-center justify-between">
        ...
        <Link href={caseId ? `/case/${caseId}/evidence` : "/dashboard"} className="flex items-center gap-0.5 text-xs font-semibold text-cyan hover:underline">
